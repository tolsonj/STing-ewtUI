App.controller('exportAssignmentController', function($scope, $state, $window, $timeout, $filter, $interval,
	ngTableParams,
	ngDialog, signService, Customer) {
	...
	$scope.BOL_list_table = function(item) {
		...
		var assignment_list = signService.getAssignmentList(params);
		$scope.getAssignmentHistoryData(assignment_list);


	};

	$scope.getAssignmentHistoryData = function(promiseobj) {
